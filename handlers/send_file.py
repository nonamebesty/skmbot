...
async def reply_forward(message: Message, file_id: int):
    try:
        ...
        await message.reply_text(
            f"**Kindly Subscribe and Support My Youtube Channel and watch videos: https://www.youtube.com/@JAsuranvideos**\n\n"
            f"**Files will be Deleted After 15 min**\n\n"
            f"**__To Retrive the Stored File, just again open the link!__**\n\n"
            f"**{caption}\n\nLink:** https://skmfilestoresbot.jasurun.workers.dev?start=Shaktimaan_{str_to_b64(str(file_id))}",
